...
function Solutions() {
  return (
    <div>
      <SectionHeading
        title="Solutions"
        subTitle="A method, strategy, or approach employed to address a specific problem or achieve a desired outcome"
      />
      <div className="grid lg:grid-cols-2 mt-20 gap-20">
        <div>
          <h3 className="mt-7 text-[32px] font-fold">A powerful tool</h3>
          <p className="mt-4 mb-8 text-gray-500">
            A resource or method that possesses significant capability,
            effectiveness, or influence in achieving desired outcomes.
          </p>
            ...
            {[1, 2, 3].map((v) => (
              ...
              >
                <p className="text-lg font-bold">
                  Constructing a simple ecosystem
                </p>
                <div className="flex justify-between relative">
                  <p className="text-lg leading-7 mt-1">
                    The process involves careful planning of factors such as
